...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/front/pay/pay.jsp" method=post
              target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input readonly id="WIDout_trade_no" name="WIDout_trade_no" value="${o.id }"/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input readonly id="WIDsubject" name="WIDsubject" value="当当网订单"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input readonly id="WIDtotal_amount" name="WIDtotal_amount" value="${o.total }"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input readonly id="WIDbody" name="WIDbody" value="老板和老板娘分家了，当当网五折优惠，原价199￥，现价99.9￥ ..."/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
