...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/front/pay/alipay.trade.page.pay.jsp" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="垃圾"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="破产大甩卖"/>
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
		...
		<div id="foot">
			...
			</ul>https://openapi.alipaydev.com/gateway.do
		</div>
	</div>
</body>
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "淘宝订单";
